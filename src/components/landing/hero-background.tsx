...
export function HeroBackground() {
  return (
    ...
    >
      ...
      <div className="hero-glow-b absolute -bottom-1/4 -left-1/12 size-[70vh] rounded-full bg-gradient-to-tl from-white/[0.09] via-white/[0.03] to-transparent blur-3xl" />
    </div>
  );
}
